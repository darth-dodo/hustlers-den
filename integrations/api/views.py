...
from knowledge.api.serializers import CategoryFormSerilaizer, MediaTypeFormSerilaizer, ExpertiseLevelFormSerilaizer 
...
class ExtensionFormData(IntegrationsAPIView):
    ...
    def get(self, request, format=None):
        ...
        data = { 
                    ...
                    'expertise_levels': ExpertiseLevelFormSerilaizer(active_expertise_levels, many=True).data
                }
