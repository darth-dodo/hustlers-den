...
from rest_framework.status import HTTP_400_BAD_REQUEST, HTTP_403_FORBIDDEN, HTTP_500_INTERNAL_SERVER_ERROR

HUSTLERS_DEN_ERROR_CONTAINER = namedtuple('HUSTLERS_DEN_ERROR_CONTAINER', ['message', 'status_code'])

DEFAULT_SERVER_ERROR = HUSTLERS_DEN_ERROR_CONTAINER(message="Something went wrong on the server side. "
