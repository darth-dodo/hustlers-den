...
class HustlersAdmin(admin.ModelAdmin):
    ...
    def formfield_for_foreignkey(self, db_field, request, **kwargs):
        ...
        return super(HustlersAdmin, self).formfield_for_foreignkey(db_field, request, **kwargs)
    ...
    def hustler_interests(obj):
        return ', '.join(obj.interests.values_list('name', flat=True)) if obj.interests.exists() else 'NA'
