...
class KnowledgeStorePacketsInline(KnowledgeStoresInline):
...
class KnowledgeStoreAdmin(admin.ModelAdmin):
    ...
    def formfield_for_foreignkey(self, db_field, request, **kwargs):
        ...
        return super(KnowledgeStoreAdmin, self).formfield_for_foreignkey(
...
class CategoriesAdmin(admin.ModelAdmin):
    ...
    def formfield_for_foreignkey(self, db_field, request, **kwargs):
        ...
        return super(CategoriesAdmin, self).formfield_for_foreignkey(
            db_field, request, **kwargs
        )
...
class MediaTypesAdmin(admin.ModelAdmin):
    ...
    def formfield_for_foreignkey(self, db_field, request, **kwargs):
        ...
        return super(MediaTypesAdmin, self).formfield_for_foreignkey(
            db_field, request, **kwargs
        )
...
class ExpertiseLevelAdmin(admin.ModelAdmin):
    ...
    def formfield_for_foreignkey(self, db_field, request, **kwargs):
        ...
        return super(ExpertiseLevelAdmin, self).formfield_for_foreignkey(
            db_field, request, **kwargs
        )
...
class PacketsAdmin(admin.ModelAdmin):
    list_display = ("__str__", "name", "slug", "created_by")
    search_fields = ["name", "slug"]
    list_display_links = ["__str__"]
    readonly_fields = ("slug",)
    list_select_related = ["created_by"]

    inlines = [KnowledgeStorePacketsInline]
    ...
    def formfield_for_foreignkey(self, db_field, request, **kwargs):
        ...
        return super(PacketsAdmin, self).formfield_for_foreignkey(
            db_field, request, **kwargs
        )
...
admin.site.register(Packet, PacketsAdmin)
